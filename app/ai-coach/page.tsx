...
export default function AiCoachPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <Badge tone="cyan">Grounded behavioral RAG</Badge>
        <h1 className="mt-3 text-3xl font-semibold text-white">AI Trade Coach</h1>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-400">
          Ask questions about your own analyzed trade history. Answers cite retrieved session evidence and avoid financial advice.
        </p>
      </div>
